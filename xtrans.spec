...
Version  : 1.6.0
Release  : 19
URL      : https://www.x.org/releases/individual/lib/xtrans-1.6.0.tar.gz
Source0  : https://www.x.org/releases/individual/lib/xtrans-1.6.0.tar.gz
Source1  : https://www.x.org/releases/individual/lib/xtrans-1.6.0.tar.gz.sig
...
%setup -q -n xtrans-1.6.0
cd %{_builddir}/xtrans-1.6.0
pushd ..
cp -a xtrans-1.6.0 build32
popd
pushd ..
cp -a xtrans-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742843602
...
cp %{_builddir}/xtrans-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xtrans/2c4f0f574086fab803a2c6478469db4fe6919fa9 || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/xtrans/2c4f0f574086fab803a2c6478469db4fe6919fa9
