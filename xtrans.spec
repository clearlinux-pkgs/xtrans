...
Version  : 1.5.2
Release  : 18
URL      : https://www.x.org/releases/individual/lib/xtrans-1.5.2.tar.gz
Source0  : https://www.x.org/releases/individual/lib/xtrans-1.5.2.tar.gz
Source1  : https://www.x.org/releases/individual/lib/xtrans-1.5.2.tar.gz.sig
...
%setup -q -n xtrans-1.5.2
cd %{_builddir}/xtrans-1.5.2
pushd ..
cp -a xtrans-1.5.2 build32
popd
pushd ..
cp -a xtrans-1.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731435588
